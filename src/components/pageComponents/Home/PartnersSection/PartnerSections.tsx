...
export default function PartnerSections() {
    ...
    return (
        <div className="relative  overflow-hidden   w-full flex flex-col justify-center items-center py-16 lg:py-24">
            ...
            <div className="flex gap-8 mt-10 flex-wrap items-center justify-between w-full container mx-auto">
